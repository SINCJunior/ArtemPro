...
export const MemberNameInput = styled.input`${retirementInputCSS}`;
export const CPFInput = styled.input`${retirementInputCSS}`;
export const RGInput = styled.input`${retirementInputCSS}`;
export const UFRGSCardInput = styled.input`${retirementInputCSS}`;
export const StartDateInput = styled.input`${retirementInputCSS}`;
export const EndDateInput = styled.input`${retirementInputCSS}`;
